...
// =========================================================
// 1. KITCHEN DASHBOARD (Now with Company Branding)
// =========================================================
export const AdminKitchenDashboard: React.FC = () => {
  // FIXED: Added currentCompany to get the brand colors
  ...
  // Company Theme Colors (Fallback to Slate/Blue if missing)
  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <div 
        ...
        style={{ 
            background: `linear-gradient(to right, ${brandColor}20, transparent)`, // Subtle gradient
...
// =========================================================
// 2. MENU MANAGER (Includes Menu Bank)
// =========================================================
export const AdminMenuManager: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-20 relative">
      ...
      <div className="bg-yellow-900/20 border-l-4 border-yellow-500 p-6 rounded-r-xl shadow-sm"><label className="block text-sm font-bold text-yellow-500 mb-2">Daily Notes & Prices (Visible to Staff)</label><textarea value={currentMenu ? currentMenu.notes : notes} onChange={(e) => { setNotes(e.target.value); if(currentMenu) updateMenu({...currentMenu, notes: e.target.value}); }} className="w-full p-3 rounded border border-yellow-700 bg-slate-900 focus:ring-2 focus:ring-yellow-500 outline-none text-sm h-20 text-white placeholder-slate-500" placeholder="Type menu notes here..." /></div>
